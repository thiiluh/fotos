...
<header>
    <div class="sticky-nav">
        ...
        <div id="logo">
        	<a id="goUp" href="#home-slider" title="ls-fotografia">ls-fotografia</a>
        </div>
        ...
        <div class="row">
            <div class="span12">
                <div class="title-page">
                    ...
                    <h3 class="title-description">Confira um pouco do meu trabalho logo abaixo.</h3>
                </div>
            </div>
        </div>
        <!-- End Title Page -->
        	...
        	<div class="span3">
                ...
                <nav id="options" class="work-nav">
                    <ul id="filters" class="option-set" data-option-key="filter">
                    	<li class="type-work">Tipo de Trabalho</li>
                        <li><a href="#filter" data-option-value="*" class="selected">Todos</a></li>
                        <li><a href="#filter" data-option-value=".design">Gravidez</a></li>
                        <li><a href="#filter" data-option-value=".photography">Ensaio em Geral</a></li>
                	...
                	<section id="projects">
                    	<ul id="thumbs">
                        	...
                        	<li class="item-thumbs span3 video">
                            	...
                            	<a class="hover-wrap fancybox-media" data-fancybox-group="video" title="Video Content From Vimeo" href="https://www.youtube.com/embed/yqoUKENUlLA?ecver=2">
                        	...
                        	<li class="item-thumbs span3 video">
                            	<!-- Fancybox Media - Gallery Enabled - Title - Link to Video -->
                            	<a class="hover-wrap fancybox-media" data-fancybox-group="video" title="Video Content From Vimeo" href="https://youtu.be/yqoUKENUlLA">
                                	<span class="overlay-img"></span>
                                    <span class="overlay-img-thumb font-icon-plus"></span>
                                </a>
                                <!-- Thumb Image and Description -->
    ...
    <div class="row">
        <div class="span12">
            <div class="title-page">
                ...
                <h3 class="title-description">Conheça um pouco da minha pessoa.</h3>
            </div>
        </div>
    </div>
    <!-- End Title Page -->
    	...
    	<div class="span4 profile">
        	<div class="image-wrap">
                <div class="hover-wrap">
                    <span class="overlay-img"></span>
                    <span class="overlay-text-thumb">A Rua é nóiz</span>
                </div>
                <img src="_include/img/profile/profile-01.jpg" alt="John Doe">
            </div>
            <h3 class="profile-name">Leandro Santana</h3>
            <p class="profile-description">Eae galera, meu numero é Leandro Santan tenho 22 anos, nascido em Campinas, sou apaixonado por fotos e mais ainda, sou apaixona pelas emoções alegrias que consigo captar do momento.Nas horas vagas me arrisco em algumas rimas cantandando uns RAP.</p>
            	
            <div class="social">
            	<ul class="social-icons">
                	
                    <li><a href="https://www.facebook.com/profile.php?id=100012538661812"><i class="font-icon-social-facebook"></i></a></li>
                </ul>
            </div>
        </div>
        <!-- End Profile -->
    ...
    <div class="row">
        <div class="span12">
            <div class="title-page">
                ...
                <h3 class="title-description">Confira nossos preço e serviços disponiveis.</h3>
            </div>
        </div>
    </div>
    <!-- End Title Page -->
    ...
    <!-- Contact Form -->
        ...
        <div class="span3">
        	<div class="contact-details">
                ...
                <ul>
                    <li><a href="#">lsfotografia@exemplo.com</a></li>
                    <li>(19) 9999-9999</li>
                    <li>
                        Leandro Santana Fotografia
            ...
            <div class="span12">
                <nav id="social">
                    <ul>
                        ...
                        <li><a href="https://www.facebook.com/fotografiasls/" title="Follow Me on Facebook" target="_blank"><span class="font-icon-social-facebook"></span></a></li>
...
<!-- Footer -->
<footer>
	<p class="credits">&copy;2017 Thiago Studios.
</footer>
<!-- End Footer -->
